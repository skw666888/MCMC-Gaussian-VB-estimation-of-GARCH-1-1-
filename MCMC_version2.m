...
N_iter = 2500; % number of interations 
N_burnin = 1000; % number of burnins 
N = N_iter+N_burnin; % total number of MCMC iterations 

dim = 3
markov_chain = zeros(N,dim); 
theta_initial = [-9,-1,-1] % starting value
...
while n < N
    ...
    if n<=1000
        ...
        Sigma = 0.01^2/dim*cov(markov_chain(n-1000:n,:)); % update Sigma based on the last 1000 iterations
